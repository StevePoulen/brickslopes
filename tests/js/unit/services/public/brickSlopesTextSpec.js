describe('service', function() {
    ...
    beforeEach(inject(function(
        ...
        bsTextFactory = _BrickSlopesText_;
    }));
    ...
    describe('brickSlopesText', function() {
        ...
        it('should create brickSlopes Text', function() {
            var expectedValue = buildPreFontWrapper() + buildPreCapWrapper('B') + buildPreCapWrapper('C') + buildPreCapWrapper('S') + '&nbsp;' + buildPreCapWrapper('A') + buildPostCapWrapper('WARDS') + buildPostWrapper();
        ...
        it('should create brickSlopes Text with a space a the first', function() {
            var expectedValue = buildPreFontWrapper() + '&nbsp;' + buildPreCapWrapper('M') + buildPostCapWrapper('Y') + buildPreCapWrapper('S') + buildPostCapWrapper('PACE') + buildPreCapWrapper('T') + buildPostCapWrapper('EST') + buildPostWrapper();
        ...
        it('should create brickSlopes Text with a parenthesis at the end', function() {
            var expectedValue = buildPreFontWrapper() + buildPreCapWrapper('G') + buildPostCapWrapper('AMES') + '&nbsp;' + buildPreCapWrapper('(') + buildPreCapWrapper('9') + buildPreCapWrapper(')') + buildPostWrapper();
            expect(bsTextFactory.createText('Games (9)')).toBe(expectedValue);
        });

        it('should create brickSlopes Text with a parenthesis at the end', function() {
            var expectedValue = buildPreFontWrapper() + buildPreCapWrapper('(') + buildPreCapWrapper('N') + buildPostCapWrapper('ICE') + '&nbsp;' + buildPreCapWrapper('P') + buildPostCapWrapper('ART') + '&nbsp;' + buildPreCapWrapper('U') + buildPostCapWrapper('SAGE') + buildPreCapWrapper(')') + buildPostWrapper();
        ...
        it('should create brickSlopes Text with a hyphen and a space', function() {
            var expectedValue = buildPreFontWrapper() + buildPreCapWrapper('B') + buildPostCapWrapper('RICKSLOPES') + '&nbsp;' + '-' + '&nbsp;' + buildPreCapWrapper('S') + buildPostCapWrapper('ALT') + '&nbsp;' + buildPreCapWrapper('L') + buildPostCapWrapper('AKE') + '&nbsp;' + buildPreCapWrapper('C') + buildPostCapWrapper('ITY') + buildPostWrapper();
        ...
        it('should create brickSlopes Text with a hyphen', function() {
            var expectedValue = buildPreFontWrapper() + buildPreCapWrapper('T') + buildPostCapWrapper('RAVEL') + '-' + buildPreCapWrapper('L') + buildPostCapWrapper('ODGE') + buildPostWrapper();
            expect(bsTextFactory.createText('Travel-Lodge')).toBe(expectedValue);
        });

        it('should create brickSlopes Text with a star', function() {
            var expectedValue = buildPreFontWrapper() + buildPreCapWrapper('T') + buildPostCapWrapper('RAVEL') + '&nbsp;' + buildPreCapWrapper('2') + buildPreCapWrapper('0') + buildPreCapWrapper('1') + buildPreCapWrapper('4') + buildPostCapWrapper('TH') + '&nbsp;' + buildPreCapWrapper('F') + buildPostCapWrapper('UN') + buildPostWrapper();
        ...
        it('should create brickSlopes Text with ... at maxsize', function() {
            var expectedValue = buildPreFontWrapper() + buildPreCapWrapper('T') + buildPostCapWrapper('RAVEL') + '&nbsp;' + buildPreCapWrapper('L') + '&nbsp;' + buildPreCapWrapper('.') + buildPostCapWrapper('..') + buildPostWrapper();
