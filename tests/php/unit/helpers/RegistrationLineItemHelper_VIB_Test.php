...
class RegistrationLineItemHelperVIBTest extends PHPUnit_Framework_TestCase 
{
    ...
    public function testAddRegistrationLineItemsEventPassWithDiscount() 
    {
        ...
        $this->assertEquals($lineItemObj['eventLineItemCodeId'], 15);
        $this->assertEquals($lineItemObj['eventId'], 2);
        $this->assertEquals($lineItemObj['userId'], 3);
        $this->assertEquals($lineItemObj['lineItem'], 'VIB Pass');
        $this->assertEquals($lineItemObj['amount'], '80.00');
    ...
    public function testAddRegistrationLineItemsEventPassWithoutDiscount() 
    {
        ...
        $this->assertEquals($lineItemObj['userId'], 3);
        $this->assertEquals($lineItemObj['lineItem'], 'VIB Pass');
        $this->assertEquals($lineItemObj['amount'], '90.00');
        $this->assertEquals($lineItemObj['paid'], 'NO');
