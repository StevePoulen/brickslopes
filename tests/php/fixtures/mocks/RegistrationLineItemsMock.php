...
class RegistrationLineItemsMock extends modelObjects {
    ...
    public function userId() { return $this->getData(__FUNCTION__,1); }
    public function lineItem() { return $this->getData(__FUNCTION__,2); }
    public function amount() { return $this->getData(__FUNCTION__,3); }
    public function paid() { return $this->getData(__FUNCTION__,4); }
    public function discount() { return $this->getData(__FUNCTION__,5); }
    public function description() { return $this->getData(__FUNCTION__,6); }
    public function size() { return $this->getData(__FUNCTION__,7); }
    public function quantity() { return $this->getData(__FUNCTION__,8); }
